package com.hishatech.java.jbox2dtest;

import com.hishatech.java.jbox2dtest.base.Ball;
import com.hishatech.java.jbox2dtest.base.BaseConstants;
import com.hishatech.java.jbox2dtest.base.Utils;
...
/**
 *
 * http://thisiswhatiknowabout.blogspot.com/2011/11/hello-world-jbox2d-with-
 * javafx-20.html
 *
 * @author dilip
 */
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		primaryStage.setTitle(BaseConstants.program_Name + " Ver"
				+ BaseConstants.program_Version);
		primaryStage.setFullScreen(false);
		primaryStage.setResizable(false);

		final Group root = new Group(); // Create a group for holding all
										// objects on the screen
		final Scene scene = new Scene(root, BaseConstants.WIDTH,
				BaseConstants.HEIGHT, Color.BLACK);

		// Ball array for hold the balls
		final Ball[] ball = new Ball[BaseConstants.NO_OF_BALLS];
		 ...
		 */
		for (int i = 0; i < BaseConstants.NO_OF_BALLS; i++) {
		...
		btn.setLayoutX((BaseConstants.WIDTH / 2));
		btn.setLayoutY((BaseConstants.HEIGHT - 30));
		btn.setText("Start");
		...
		EventHandler<MouseEvent> addHurdle = new EventHandler<MouseEvent>() {
			public void handle(MouseEvent me) {
				...
				Ball hurdle = new Ball(Utils.toPosX(dragX),
						Utils.toPosY(dragY), 2, BodyType.STATIC, Color.BLUE);
